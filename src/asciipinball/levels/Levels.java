...
public abstract class Levels {
    ...
    public static final PhysicEntity[] LEVEL1 = new PhysicEntity[]{
            ...
            new LineWall(0,25,(((float)Settings.WIDTH/2) - (Settings.HOLE_WIDTH/2)), 15, false, false),
            new LineWall(100,25,(((float)Settings.WIDTH/2) + (Settings.HOLE_WIDTH/2)), 15, false, false),
